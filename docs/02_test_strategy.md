...
| --- | --- | --- | --- | --- | --- |
| **동일 카테고리 내 상품 간 추천 기능 노출 불일관성** | 3점 | 2점 | 6점 | P1 | UX 혼란 |
| **추천 리스트 클릭 시 화면 전환 실패** | 3점 | 1점 | 3점 | P2 | 기능 불능 |
| **추천 상품 수량/항목이 상품 특성과 불일치** | 2점 | 2점 | 4점 | P2 | 신뢰도 저하 |
| **썸네일 이미지 로딩 실패** | 1점 | 2점 | 2점 | P3 | 모바일 네트워크 환경 |
| **로그인 상태 여부에 따른 노출 차이** | 2점 | 1점 | 2점 | P3 | 기능 제약 없음 |
